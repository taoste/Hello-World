...
<a href="https://www.jianshu.com/u/1441f4ae075d" title="🛡 Adobe Flash Player 插件">Adobe Flash Player 插件</a> ：<br>
<img class="bottom"  src="https://github.com/taoste/Hello-World/blob/master/Tools/Adobe%20PDF/QQ%E6%8F%92%E4%BB%B6%E4%B8%8B%E8%BD%BD.jpg?raw=true" height="10%" width="10%"><br>
...
<p><b>二、可以打开PS软件的情况下:</b></p>
<p>1. 编辑--清理--全部（这个位置已经清理过了，所以显示灰色）</p>
<p>2.修改暂存盘位置</p>
<p>编辑--首选项--暂存盘或ctrl K--暂存盘</p>
<p>系统默认选择C盘，选择空闲空间比较大的盘，取消C盘的勾，这边我选择G盘</p>
<p>3.编辑--首选项--文件处理--camera Raw首选项--情况高速缓存（清理camera Raw的缓存文件），点击‘选择位置’更改缓存路径。</p>
<p>然后点击确定，确定就可以了，有时候需要重启软件才可以生效。</p>
