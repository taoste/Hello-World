...
**Readme：Chrome 插件：谷歌上网助手**（[**安装图示**](https://taoste.github.io/Hello-World/Tools/Google%20Chrome/Chrome插件（CRX文件）/Chrome%20插件：谷歌上网助手/安装图示.jpg?raw=true))
...
>   **开发者**
> 
>  提供方：**Google Helper 官网** http://googlehelper.net/ （[官网下载](http://googlehelper.net/download/Ghelper_1.4.6.beta.zip)）
