...
- [ ] 10. **Anything to QRcode** （网址生成的二维码(已失效) | 推荐：[**二维码生成器(QuickQR)**](https://chrome.google.com/webstore/detail/quick-qr-code-generator/afpbjjgbdimpioenaedcjgkaigggcdpp/related?hl=zh-cn) 
